...
const AsideMenu = (props: any) => {
    ...
    return (
        <aside className={`flex flex-col dark:bg-gray-900 dark:text-gray-200 bg-gray-200 text-gray-900`}>
            ...
            <div className={``}>
                <MenuItem icon={LogoutIcon} title="Exit" onClick={logout} classes={`text-red-600 dark:text-red-800 dark:hover:bg-gray-200 dark:hover:text-red-400 hover:bg-red-400 hover:text-white`}></MenuItem>
            </div>
        </aside>
    )
}
